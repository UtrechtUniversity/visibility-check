...
--
-- Host: 127.0.0.1    Database: vcadmin
-- ------------------------------------------------------
...
CREATE TABLE `answers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19227 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `solisid` varchar(255) NOT NULL,
  `remember_token` varchar(100) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_solisid_unique` (`solisid`)
...
-- Dump completed on 2025-10-24 11:33:32
